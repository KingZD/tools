...
import com.file.manager.cache.CacheEntity;
import com.file.manager.cache.CacheMode;
import com.file.manager.cookie.CookieJarImpl;
import com.file.manager.https.HttpsUtils;
import com.file.manager.interceptor.HttpLoggingInterceptor;
import com.file.manager.model.HttpHeaders;
import com.file.manager.model.HttpParams;
import com.file.manager.request.GetRequest;
import com.file.manager.request.PostRequest;
import com.file.manager.utils.HttpUtils;
...
public class OkGo {
    ...
    private OkGo() {
        ...
        HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor("com.file.manager.OkGo");
    ...
    public Context getContext() {
        HttpUtils.checkNotNull(context, "please call com.file.manager.OkGo.getInstance().init() first in application!");
        return context;
    }
    ...
    public OkHttpClient getOkHttpClient() {
        HttpUtils.checkNotNull(okHttpClient, "please call com.file.manager.OkGo.getInstance().setOkHttpClient() first in application!");
        return okHttpClient;
    }
