package com.zed.tools.calendar.datapicker.time;
...
public class HourAndMinutePicker extends LinearLayout implements
    ...
    public String getHourStr() {
        ...
        int currentPosition = mHourPicker.getCurrentPosition();
        if (currentPosition < 10)
            hour.append("0");
        hour.append(currentPosition);
    ...
    public String getMinuteStr() {
        StringBuffer hour = new StringBuffer();
        int currentPosition = mMinutePicker.getCurrentPosition();
        if (currentPosition < 10)
            hour.append("0");
        hour.append(currentPosition);
        return hour.toString();
    ...
    public String getTime() {
        return getHourStr().concat(":").concat(getMinuteStr());
    }
